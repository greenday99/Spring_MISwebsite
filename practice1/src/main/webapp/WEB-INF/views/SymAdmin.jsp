	...
	<div id="content" class="container">
		...
		<div class="container">
			<div class="row">
				...
				<div class="col-md-9">
					<a class="btn btn-primary" href="insertSym">新增文章</a>
					<table class="table">
						<tr>
							<th>時間</th>
							<th>研討會名稱</th>
						...
						<c:forEach items="${symList}" var="sym">
							<tr>
								<td>${sym.sym_time}</td>
								<td><a href="${sym.sym_url}" style="color: #5599FF">${sym.sym_name}</a></td>
								<td><a class="btn btn-default"
									href="updateSym?sym_code=${sym.sym_code}">修改</a> <a
									class="btn btn-sm btn-danger deleteBtn"
									href="deleteSym?sym_code=${sym.sym_code}">刪除</a></td>
							</tr>
						</c:forEach>
					</table>
				</div>
