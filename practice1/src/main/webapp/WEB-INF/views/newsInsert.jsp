...
<div class="container">
	...
	<p style="color:red"><font size="5">${message}</font></p>
	<form method="post" action="newsInsert" enctype="multipart/form-data">
		<label>公告標題</label>
		<div><textarea name="buTitle" rows="1" cols="40" required></textarea></div><br>
		<label>公告類別</label>
		<div>
			<select name="sCode">
		...
		<label>公告內容</label>
		<div><textarea name="buCont" rows="5" cols="60"></textarea></div><br>
		<script>         
		...
		<br><input type="button" id="addFile" value="新增檔案" /><br>
