		...
		<form method="post" action="updateass" id="updateForm"  modelAttribute="uploadForm" enctype="multipart/form-data">
			...
			<div class="form-group">
				...
				<select class="form-control" name="post_name">
					<option value="AA" ${updateass.post_name=="系統管理員"?'selected':''}>系統管理員</option>
					<option value="DB" ${updateass.post_name=="系秘"?'selected':''}>系秘</option>
					<option value="DC" ${updateass.post_name=="助教"?'selected':''}>助教</option>
					<option value="DZ" ${updateass.post_name=="離校"?'selected':''}>離校</option>
				</select>
			</div>
