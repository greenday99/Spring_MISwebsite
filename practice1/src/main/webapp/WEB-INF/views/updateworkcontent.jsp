...
<body>
	...
	<div class="container">	
		...
		<c:forEach items="${updateworkcontent}" var="updateworkcontent">
			<form method="post" action="updateworkcontent" id="updateForm">	
	  			<div class="form-group">
				<br/>
				<input type="hidden" name="teachercode" value="${updateworkcontent.teachercode}">
				<input type="hidden" name="asistantWorkID" value="${updateworkcontent.asistantWorkID}">
				<textarea type="text" name="workContent" rows="3" cols="40">${updateworkcontent.workContent}</textarea>
